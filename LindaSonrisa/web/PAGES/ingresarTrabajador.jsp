<%-- 
    ...
    Created on : 15-06-2018, 10:13:58
    Author     : andres
--%>
            ...
            <section id="intro">
                ...
                <div class="intro-text">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <br>
                        <c:if test="${msg=='error'}">
                            <span  id="error" class="errormessage" style="color: red" >El rut o la contraseña son invalidos</span>
                        </c:if>
                        <br>
                        <a href="#" class="btn-get-started scrollto" onclick="document.formulario.submit()" >Entrar</a>
                    </div>
                </div>
